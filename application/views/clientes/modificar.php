	<?php 
		...
		$data['cliente_direccion'] = $cliente_direccion[0];
		$data['provincia'] = $cliente_provincia;
		$data['pais'] = $cliente_pais;
		...
		foreach ($cliente as $row) {
            ...
            $data['datepicker'] = $row['fecha_nacimiento'];
            $data['medida_camiseta'] = $row['camiseta'];
		}*/
		if(!empty($cliente_direccion)) {
			foreach ($cliente_direccion as $row) {
				// $data['direccion_id'] = $row['direccion_id'];
				...
				<div class="col-md-12">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							...
							<div class="caption">
								<i class="fa fa-user fa-2x"></i>Completar el formulario del Cliente Seleccionado
							</div>
							<div class="tools">								
							</div>
						</div>
						...
						<!-- BEGIN FORM-->
						<?php echo $this->load->view('clientes/form_modify_cliente', $data, TRUE); ?>
						<!-- END FORM-->
						</div>
					</div>
...
jQuery(document).ready(function() {       
	...
	autocompleteNombreURL = '<?=$autocompleteNombreURL;?>';
	autocompleteModificarURL = '<?=$autocompleteNombreURL;?>';
	autocompleteApellidoURL = '<?=$autocompleteApellidoURL;?>';
	
	//FormValidaton.js Confirmation Dialog
