	...
	?>								
										...
										<form id="formClient" action="/clientes/salvar_cliente" class="form-horizontal" method="post">
											<?php echo form_hidden('action', 'modify');?>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<?php echo form_dropdown('pais', $paises, !empty($cliente_pais) ? key($cliente_pais) : 14, 'id="paises" class="select2_category form-control"'); ?>
