				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">				
							...
							<div class="actions">
								<a href="/<?php echo $tableAddButtonHref;?>/nuevo" class="btn btn-default btn-sm">
								<i class="fa fa-plus"></i> <?php echo $tableAddButton;?></a>
								<a href="#" class="btn btn-default btn-sm deleteSelected">
								<i class="fa fa-trash-o"></i> Delete Selected &nbsp<span class="badge badge-default totalItemsSelected">0</span></a>
							</div>
							<div class="tools">
							</div>
						</div>
