				...
				<div class="col-md-12">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							...
							<div class="caption">
								<i class="fa fa-user fa-2x"></i><?=$portlet_caption;?>
							</div>
							<div class="tools">								
							</div>
						</div>
						...
						<!-- BEGIN FORM-->
						<?php echo $this->load->view('eventos/form_nuevo_evento', $this->data, TRUE); ?>
						<!-- END FORM-->
						</div>
					</div>
...
jQuery(document).ready(function() {       
	...
	//autocompleteApellidoURL = '<? //echo $autocompleteApellidoURL;?>';
