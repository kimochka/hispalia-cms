...
class Delegados extends CI_Controller {
	...
	function index() {
		...
		$tmpl = array(
			'table_open'		  => '<table class="table table-striped table-bordered table-hover" id="datatable_clientes">',
		...
		$this -> table -> set_heading('<input type="checkbox" class="group-checkable" data-set="#datatable_clientes .checkboxes"/>', 'Apellido', 'Nombre', 'Address', 'City', 'Region', 'Country', 'Tlf', 'e-mail', 'Talla Camiseta', 'Actions');
		...
		*/
		...
		foreach ($query->result() as $row) {
			...
			// $tabla[$i]['Delete'] = '<button id="button-delete-'. $cID .'" class="delete">Delete</button>';
			$actions = '
            <div cliente="'.$cID.'">
		...
		$this->load->view("delegados/index", $this->data);

		//$this->load->view('tabla_general', $data);
	...
	function nuevo() {
		...
		*/	
		...
		$this->load->view("delegados/nuevo", $this->data);
	}
	...
	function modificar() {
		...
		$this->data['header_title'] = "Hispalia | Delegados - Modificar";

		$this->load->view('delegados/modificar', $this->data);
